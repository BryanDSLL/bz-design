    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="overflow-hidden inline-block mb-2">
          <h1 
            ref={textRef1}
            className="text-[17vw] md:text-[14vw] lg:text-[11vw] font-extrabold tracking-tighter uppercase leading-[0.85] text-white"
          >
            Digital
          </h1>
        </div>
        <div className="overflow-hidden inline-block mb-8">
          <h1 
            ref={textRef2}
            className="text-[17vw] md:text-[14vw] lg:text-[11vw] font-extrabold tracking-tighter uppercase leading-[0.85] text-transparent"
      ...
      <div className="absolute bottom-10 left-10 text-xs font-mono tracking-widest text-zinc-500 uppercase overflow-hidden">
        <div className="animate-pulse">Scroll to discover</div>
      </div>
      <div className="absolute bottom-10 right-10 text-xs font-mono tracking-widest text-zinc-500 uppercase overflow-hidden">
